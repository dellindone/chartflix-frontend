...
export default function SuggestionsBar({ alerts = [], dateFrom, dateTo, onSetDirection, onSetCategory, onSetQuickDate }) {
  const chips = useMemo(() => {
    const inDate = (a) => {
    ...
    return result;
  }, [alerts, dateFrom, dateTo, onSetCategory, onSetDirection, onSetQuickDate]);
